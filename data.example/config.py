THREADS = 20  # for register account / claim rewards mode / approve email mode
MIN_PROXY_SCORE = 25  # Put MIN_PROXY_SCORE = 0 not to check proxy score (if site is down)
